...
class BetterAGCWrapper():
    def __init__(self, model, **kwargs):
        ...
        elif method_name == 'better_agc_plus1':
            self.method = BetterAGC_plus1(self.model)
        elif method_name == 'better_agc_cluster':
            self.method = BetterAGC_cluster(self.model)
        elif method_name == 'better_agc_plus5':
            self.method = BetterAGC_plus5(self.model)
